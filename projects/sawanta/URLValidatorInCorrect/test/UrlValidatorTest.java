...
//You can use this function to implement your manual testing
	   System.out.print("URL Validator Manual Test\n----------------------------\n\n");
       UrlValidator urlTest = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);

       // Valid URL forms
       String v0 = "http://www.google.com",
           v1 = "http://www.google.com:80",
           v2 = "http://www.google.com:80/test1",
           v3 = "http://www.google.com:80/test1/file",
           v4 = "http://www.google.com:80/test1/file?action=view",
           v5 = "http://go.au/t123",
       ...
       String i0 = "http:/www.google.com", 	// Invalid scheme
           i1 = "http://256.256.256.256",		// Invalid authority
           i2 = "http://www.google.com:65636",	// Invalid port
           i3 = "http://go.com/../",			// Invalid path
           i4 = "3ht://1.2.3.4.5",				// Invalid scheme + authority
           i5 = "://go.au:65a",				// Invalid scheme + port
           i6 = "http:/go.au/#/file",			// Invalid scheme + path
           i7 = "3ht://www.go.com",			// Invalid scheme
           i8 = "http://www.255",				// Invalid authority
           i9 = "http:/.aaa";					// Invalid scheme + authority

       // Run tests on valid URLs
       System.out.println("*Valid URL Tests*\n");
       System.out.println("URL: " + v0 + "\nResult: " + urlTest.isValid(v0) + '\n');
       System.out.println("URL: " + v1 + "\nResult: " + urlTest.isValid(v1) + '\n');
       System.out.println("URL: " + v2 + "\nResult: " + urlTest.isValid(v2) + '\n');
       System.out.println("URL: " + v3 + "\nResult: " + urlTest.isValid(v3) + '\n');
       System.out.println("URL: " + v4 + "\nResult: " + urlTest.isValid(v4) + '\n');
       System.out.println("URL: " + v5 + "\nResult: " + urlTest.isValid(v5) + '\n');
       System.out.println("URL: " + v6 + "\nResult: " + urlTest.isValid(v6) + '\n');
       ...
       System.out.println("\n\n*Invalid URL Tests*\n");
       System.out.println("URL: " + i0 + "\nResult: " + urlTest.isValid(i0) + '\n');
       System.out.println("URL: " + i1 + "\nResult: " + urlTest.isValid(i1) + '\n');
       System.out.println("URL: " + i2 + "\nResult: " + urlTest.isValid(i2) + '\n');
       System.out.println("URL: " + i3 + "\nResult: " + urlTest.isValid(i3) + '\n');
       System.out.println("URL: " + i4 + "\nResult: " + urlTest.isValid(i4) + '\n');
       System.out.println("URL: " + i5 + "\nResult: " + urlTest.isValid(i5) + '\n');
       System.out.println("URL: " + i6 + "\nResult: " + urlTest.isValid(i6) + '\n');
       System.out.println("URL: " + i7 + "\nResult: " + urlTest.isValid(i7) + '\n');
       System.out.println("URL: " + i8 + "\nResult: " + urlTest.isValid(i8) + '\n');
       System.out.println("URL: " + i9 + "\nResult: " + urlTest.isValid(i9) + '\n');
   ...
   public void testYourFirstPartition()
   {
	 //You can use this function to implement your First Partition testing (random testing)
	   ...
	   //String userinfo = generator.generateByRegex("[A-Za-z0-9]+");
	   String userinfo = "";
	   l = rand.nextInt(50) + 1;
	   for(int j = 0; j < l; j++) {
...
//	        "tp",                 // East Timor (Retired)
   ...
   public void testIsValid()
   {
	   ...
	   try {
		   //FileReader readFile = new FileReader("validurl.txt");
		   System.out.print("\n*Unit Testing VALID http URLs from File*\n=================\n");
		   FileReader readFile = new FileReader("validhttponly.txt");
		   ...
		   System.out.print("Invalid URLS: "+ invalidUrls + "\n");
		   readFile.close();
	   } catch (IOException e) {
		   e.printStackTrace();
	   }
	   ...
	   try {
		   System.out.print("\n*Unit Testing INVALID http URLs from File*\n=================\n");
		   FileReader readFile = new FileReader("invalidhttp.txt");
		   BufferedReader br = new BufferedReader(readFile);
	   ...
	   // Build and test invalid URLs
	   System.out.print("\n*Unit Testing INVALID URLs*\n=================\n");
	   
	   int good = 0;
	   int bad = 0;
	   
	   String[] invalidAuthority = {"256.256.256.256", "1.2.3.4.5", "go.a",""};
	   String[] invalidPort = {":-1", ":65636", ":999999999999999999", ":65a"};
	   String[] invalidPath = {"/..", "/../", "/..//file", "/test1//file"};
	   String[] query = {"?action=view", "?action=edit&mode=up", "?pli=1", ""};
	   
	   for (int i = 0; i < 4; ++i) {
		   for (int j = 0; j < 4; ++j) {
			   for (int k = 0; k < 4; ++k) {
				   for(int m = 0; m < 4; ++m) {
					   String testurl = "http://" + invalidAuthority[i] + invalidPort[j] + invalidPath[k] + query[m];
					   result = urlVal.isValid(testurl);
					   if (!result) {
						   //System.out.println("Invalid: " + testurl);
						   bad++;
					   }
					   else {
						   System.out.println("Valid: " + testurl);
						   good++;
					   }
				   }
			   }
	   ...
	   System.out.println("Valid URLs: " + good);
	   System.out.println("Invalid URLs: " + bad + "\n");
	   
	   
	   // Testing ResultPair
	   System.out.print("\n*Unit Testing VALID URL with ResultPair*\n=================\n");
	   
	   ResultPair[] testValidUrl = {new ResultPair("http://www.facebook.com/test1", true),
			   						new ResultPair("http://go.au", true),
	   ...
	   for (int i = 0; i < 4; ++i) {
		   ...
		   toTestUrl = testValidUrl[i].item;
		   expected &= testValidUrl[i].valid;
		   result = urlVal.isValid(toTestUrl);
		   if (result == expected) {
			   System.out.println("Valid URL: " + toTestUrl);
		   }
		   else {
			   System.out.println("Invalid URL: " + toTestUrl);
		   }
	   }   
   }
